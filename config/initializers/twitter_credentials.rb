...
# TWITTER_CLIENT = Twitter::REST::Client.new do |config|
#                   config.consumer_key = 'EgnavLeK4rkzrsQBGecraUPI1'
#                   config.consumer_secret = 'NTHYMqZHCQsgo8FxBChK7B8RwpcwKKAJsQztnEILHcKgbNIFf2'
#                   config.oauth_token = '94298024-5Iafkcb17TuPNnZlrnTxX4HhpQkX0XX5CVHZ6g2Xg'
#                   config.oauth_token_secret = '7jgUiljKk4zPCrRxVWHg5amcgOVVYqRCTKessBU0PG61f'
#                 end
